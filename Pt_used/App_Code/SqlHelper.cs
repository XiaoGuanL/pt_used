...
public class SqlHelper
{
    ...
    public static readonly string connstring = ConfigurationManager.ConnectionStrings["DBConnStr"].ConnectionString;
    ...
    {
        return new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnStr"].ConnectionString);
    }
    /// <summary>
    /// 打开数据库连接
    /// </summary>
